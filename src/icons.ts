...
export const icons = {
  ...
  spotlight: svg(
    `<circle cx="12" cy="12" r="4.6"/><path d="M12 3.4v2.6M12 18v2.6M3.4 12h2.6M18 12h2.6M5.9 5.9l1.85 1.85M16.25 16.25l1.85 1.85M18.1 5.9l-1.85 1.85M7.75 16.25 5.9 18.1"/>`,
  ),
  magnifier: svg(
    `<circle cx="10.6" cy="10.6" r="5.9"/><path d="M15 15 20 20"/><path d="M8.2 10.6h4.8M10.6 8.2v4.8"/>`,
  ),
  bubble: svg(
    `<path d="M4.6 6.4h14.8a1.4 1.4 0 0 1 1.4 1.4v8a1.4 1.4 0 0 1-1.4 1.4h-8.2L7 20.6v-3.4H4.6a1.4 1.4 0 0 1-1.4-1.4v-8a1.4 1.4 0 0 1 1.4-1.4Z"/>`,
  ),
  sticker: svg(
    `<path d="M4.6 5.4h14.8v8.2l-5.4 5.4H4.6z"/><path d="M19.4 13.6h-5.4v5.4"/><path d="M8.2 10.4h4.4"/>`,
  ),
  erase: svg(
    `<path d="M4.8 15.2 12.9 7a2 2 0 0 1 2.85 0l3.35 3.35a2 2 0 0 1 0 2.85l-6.9 6.9H8.4z"/><path d="M8.4 20.1h11.2"/>`,
  ),
